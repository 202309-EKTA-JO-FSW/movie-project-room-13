          ...
          <div class="px-5 xl:px-12 py-6 flex w-full items-center">
            ...
            <ul class="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
              ...
              <div className="movie-links hover:text-gray-200 bg-teal-500">
                ...
                <select class="hover:text-gray-200 italic bg-teal-500" id="genre" onChange={onChange={(e) => onSelectGenre(e.target.value)}>
            ...
            <li><div className="movie-links hover:text-gray-200 italic bg-teal-500">
                <select value={selectedType} onChange={(e) => onSelectType(e.target.value)} class="bg-teal-500">
